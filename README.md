...
* Machine Learning is awesome
    ...
    * Core epiphanies on machine learning:
        ...
        * Ways to improve our learned machine:
        ...
        * To be added: brief explanation of naive bayes and different types
...
* Cover edge cases, for example if a search query has no tweets
