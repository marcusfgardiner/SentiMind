...
exports.default = {
  ...
  allSetsEqual: function (itemSets) {
    return itemSets.every(function (comparisonSet) {
      return (0, _fastDeepEqual2.default)(comparisonSet[0], comparisonSet[1]);
    });
  },
  ...
  */
  areVictoryPropsEqual: function (a, b) {
    try {
      return (0, _fastDeepEqual2.default)(a, b);
    } catch (err) {
      _log2.default.warn("VictoryError: fastDeepEqual. https://github.com/FormidableLabs/victory/issues/964");
      return false;
    }
  }
};